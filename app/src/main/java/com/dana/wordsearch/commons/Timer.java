...
public class Timer {
    ...
    private final List<OnTimeoutListener> mTimeoutListeners;
    private final List<OnStoppedListener> mStoppedListeners;
    private final List<OnStartedListener> mStartedListeners;
