...
import com.dana.wordsearch.commons.GridIndex;
import com.dana.wordsearch.commons.Util;
import com.dana.wordsearch.custom.layout.CenterLayout;
...
public class LetterBoard extends CenterLayout implements Observer {
    ...
    public void setLetterFontFamily(Typeface typeface) {
        mLetterGrid.setfontfamily(typeface);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
           ...
           // int fontType=a.getInt(R.styleable.LetterBoard_fontFamily,R.font.uomobold);

            Typeface fantfamily = ResourcesCompat.getFont(context,R.font.uomobold);
            ...
            setLetterFontFamily(fantfamily);
