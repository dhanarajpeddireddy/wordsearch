...
import com.dana.wordsearch.data.GameDataSource;
...
public class GameDataSQLiteDataSource implements GameDataSource {
    ...
    public long saveGameData(GameDataEntity gameRound) {
        ...
        for (UsedWord usedWord : gameRound.getUsedWords()) {
            ...
            values.put(DbContract.UsedWord.COL_PATH_LINE_DATA, usedWord.getPath().toString());
    ...
    private List<UsedWord> getUsedWords(int gid) {
        ...
        String[] cols = {
                ...
                DbContract.UsedWord.COL_PATH_LINE_DATA,
        ...
        if (c.moveToFirst()) {
            while (!c.isAfterLast()) {
                ...
                String patheData = c.getString(3);
                int col = c.getInt(4);
                ...
                if (patheData != null) {
                    ...
                    usedWord.getPath().fromString(patheData);
                ...
                usedWord.setIsMystery(Boolean.parseBoolean(c.getString(5)));
                usedWord.setRevealCount(c.getInt(6));
